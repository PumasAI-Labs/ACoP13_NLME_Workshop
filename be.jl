...
##BE with Cmax
output_cmax = pumas_be(pkdata; endpoint = :Cmax, id = :id, sequence = :sequence, period = :period)

##BE with AUC
output_auc = pumas_be(pkdata; endpoint = :AUC, id = :id, sequence = :sequence, period = :period)
...
cmax_output_nonfed = pumas_be(pkdata; endpoint = :Cmax, reference = 'N', id = :id, sequence = :sequence, period = :period,)
